...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{A native implementation of mime-types which improves both memory usage and performance.}
  spec.homepage      = "https://github.com/ioquatix/mime-types-mini"
